  ...
  outputs = {self, ...} @ inputs:
    ...
    in {
      ...
      in {
        ...
        install-eduroam-university-bonn =
          pkgs.writeShellScriptBin "install-eduroam-university-bonn"
          "${python-with-dbus}/bin/python3 ${eduroam-university-bonn}";

        # nix run .#install-eduroam-university-koeln
        install-eduroam-university-koeln =
          pkgs.writeShellScriptBin "install-eduroam-university-koeln"
          "${python-with-dbus}/bin/python3 ${eduroam-university-koeln}";

        # nix run .#install-eduroam-lund-university
        install-eduroam-lund-university =
          pkgs.writeShellScriptBin "install-eduroam-university-lund"
          "${python-with-dbus}/bin/python3 ${eduroam-lund-university}";

        # nix run .#install-eduroam-university-siegen
        install-eduroam-university-siegen =
          pkgs.writeShellScriptBin "install-eduroam-university-siegen"
          "${python-with-dbus}/bin/python3 ${eduroam-university-siegen}";

        # nix run .#install-eduroam-saarland-university
        install-eduroam-saarland-university =
          pkgs.writeShellScriptBin "install-eduroam-saarland-university"
          "${python-with-dbus}/bin/python3 ${eduroam-saarland-university}";

        install-eduroam-leipzig-university =
          pkgs.writeShellScriptBin "install-eduroam-university-leipzig"
